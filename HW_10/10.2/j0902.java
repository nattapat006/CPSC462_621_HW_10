...
public class j0902 {
  public static void main (String args[]) throws IOException {
    ...
    i = 0;
    //
    FileReader fin2 = new FileReader("Orders.txt");
    ...
    for(int j=0;j<t1;j++) {
      ...
      System.out.println("Orderdetail"+" = "+fields[0] +" , "+ fields[1] +" , "+  fields[2]+" , "+  fields[3]+" , "+  fields[4]);
     Ordid = fields[0];
      for(int k=0;k<t2;k++) {
        fields = recs2[k].split(",");
        if (fields[0].equals(Ordid)) {
           System.out.println("Order"+" = "+fields[1]+" , "+ fields[2]+" , "+ fields[3]);
